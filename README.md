...
```sh
dist/codex-dashboard-0.1.6.dmg
```

## Download

[Download codex-dashboard 0.1.6 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.6/codex-dashboard-0.1.6.dmg)
