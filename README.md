...
```sh
dist/codex-dashboard-0.1.10.dmg
```

## Download

[Download codex-dashboard 0.1.10 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.10/codex-dashboard-0.1.10.dmg)
