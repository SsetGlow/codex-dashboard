...
```sh
dist/codex-dashboard-0.1.12.dmg
```

## Download

[Download codex-dashboard 0.1.12 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.12/codex-dashboard-0.1.12.dmg)
