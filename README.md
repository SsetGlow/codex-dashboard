...
```sh
dist/codex-dashboard-0.1.11.dmg
```

## Download

[Download codex-dashboard 0.1.11 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.11/codex-dashboard-0.1.11.dmg)
