...
```sh
dist/codex-dashboard-0.1.1.dmg
```

## Download

[Download codex-dashboard 0.1.1 DMG](https://raw.githubusercontent.com/SsetGlow/codex-dashboard/v0.1.1/dist/codex-dashboard-0.1.1.dmg)
