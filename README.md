...
```sh
dist/codex-dashboard-0.1.3.dmg
```

## Download

[Download codex-dashboard 0.1.3 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.3/codex-dashboard-0.1.3.dmg)
