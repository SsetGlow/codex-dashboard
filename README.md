...
```sh
dist/codex-dashboard-0.1.5.dmg
```

## Download

[Download codex-dashboard 0.1.5 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.5/codex-dashboard-0.1.5.dmg)
