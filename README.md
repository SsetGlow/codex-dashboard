...
```sh
dist/codex-dashboard-0.1.4.dmg
```

## Download

[Download codex-dashboard 0.1.4 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.4/codex-dashboard-0.1.4.dmg)
