...
```sh
dist/codex-dashboard-0.1.2.dmg
```

## Download

[Download codex-dashboard 0.1.2 DMG](https://github.com/SsetGlow/codex-dashboard/releases/download/v0.1.2/codex-dashboard-0.1.2.dmg)
